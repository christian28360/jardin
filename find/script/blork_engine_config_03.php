...
// Car il est rajouté automatiquement 
    "../..",
//    ".", ici c'est le dossier de engine.php
...
$liste_extensions["img"] = array(
    ...
    "png",
    "tiff",
     * en commentaire pour ne pas scanner les images, modif C.A. du 02/06/2020
     */
    "toto",  // pseudo fichier image pour éviter plantage du module car je ne veux pas trouver les images
);
